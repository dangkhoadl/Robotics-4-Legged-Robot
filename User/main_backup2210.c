...
void X360_Y1_Analog (void)
{
	...
	void walk (void)
	{
		while (Y1_Analog > 10)
		{
			theta_1_L = (int8_t)(20*sin (2*pi*f*t/1000));
			theta_1_R = (int8_t)(20*sin (2*pi*f*t/1000));
			LFL_1_set (theta_1_L,1);
			LHL_1_set (theta_1_L,1);
			RFL_1_set (-theta_1_R,1);
			RHL_1_set (-theta_1_R,1);
			theta_2_L = (int8_t)(60*sin (2*pi*f*t/1000 + pi/2));
			theta_2_R = (int8_t)(60*sin (2*pi*f*t/1000 + pi/2));
			if (theta_2_L >= 0)
			{
				LFL_2_set (theta_2_L,1);
				LHL_2_set (0,1);
				RFL_2_set (0,1);
				RHL_2_set (theta_2_R,1);
				
			}
			else 
			{
				LFL_2_set (0,1);
				LHL_2_set (-theta_2_L,1);
				RFL_2_set (-theta_2_R,1);
				RHL_2_set (0,1);
