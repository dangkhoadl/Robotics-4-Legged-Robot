...
//LHL
#define phi0_LHL_2 2944
#define phi0_LHL_1 4270 
...
int creep_FL_wp_0[3] = 	{0,-26,43},  //    	 				 [0  14 0]

		creep_FL_wp_1_Stance[3]  = 	  {0,10,16}, //      [0  14   5]
		creep_FL_wp_1_Stretch[3] = 		{0,19,0}, //       [0  14.5 5]
		creep_FL_wp_1_Flex[3]    = 		{0,-6,46}, //      [0  13   5]
		creep_FL_wp_1_Swing[3]   = 		{0,-27,86}, //      [0  10   5]
		
		creep_FL_wp_2_Stance[3]  = 	  {0,-9,35}, //      [0  14   3]
		creep_FL_wp_2_Stretch[3] = 		{0,0,19}, //      [0  14.5 3]
		creep_FL_wp_2_Flex[3]    = 		{0,-21,56}, //      [0  13   3]
		creep_FL_wp_2_Swing[3]   = 		{0,-43,94},//				[0  10   3]
		
		creep_FL_wp_3_Stance[3]  = 	  {0,-21,42},  //     [0  14   1]
		creep_FL_wp_3_Stretch[3] = 		{0,-14,29},  //     [0  14.5 1]
		creep_FL_wp_3_Flex[3] 	 = 		{0,-33,61},  //     [0  13   1]
		creep_FL_wp_3_Swing[3] 	 =		{0,-57,99},  //     [0  10   1]
		
		creep_FL_wp_4_Stance[3]  = 	  {0,-30,42}, //      [0  14   -1]
		creep_FL_wp_4_Stretch[3] = 		{0,-22,29}, //      [0  14.5 -1]
		creep_FL_wp_4_Flex[3]    = 		{0,-41,61}, //      [0  13   -1]
		creep_FL_wp_4_Swing[3]   = 		{0,-68,99}; //      [0  10   -1]

////					theta  0  1   2		 pos		 z  x  y
int creep_HL_wp_0[3] = 	{0,-32,40},  //    	  			[0  14 0]

		creep_HL_wp_1_Stance[3]  = 	{0,-30,42}, //     	[0  14   -1]
		creep_HL_wp_1_Stretch[3] = 	{0,-22,29}, //      [0  14.5 -1]
		creep_HL_wp_1_Flex[3]    = 	{0,-41,61}, //      [0  13   -1]
		creep_HL_wp_1_Swing[3]   = 	{0,-68,99}, //      [0  10   -1]
		
		creep_HL_wp_2_Stance[3]  = 	{0,-21,42}, //      [0  14    1]
		creep_HL_wp_2_Stretch[3] = 	{0,-14,29}, //      [0  14.5  1]
		creep_HL_wp_2_Flex[3]		 = 	{0,-33,61}, //      [0  13    1]
		creep_HL_wp_2_Swing[3] 	 = 	{0,-57,99}, //      [0  10    1]
		
		creep_HL_wp_3_Stance[3]  =  {0,-9,35},  //     	[0  14   3]
		creep_HL_wp_3_Stretch[3] = 	{0,0,19},  //     	[0  14.5 3]
		creep_HL_wp_3_Flex[3] 	 = 	{0,-21,56},  //     [0  13   3]
		creep_HL_wp_3_Swing[3] 	 = 	{0,-43,94},  //     [0  10   3]
		
		creep_HL_wp_4_Stance[3]  =  {0,10,16}, //      [0  14    5]
		creep_HL_wp_4_Stretch[3] = 	{0,19,0}, //      	[0  14.5  5]
		creep_HL_wp_4_Flex[3]    = 	{0,-6,46}, //      [0  13    5]
		creep_HL_wp_4_Swing[3] 	 = 	{0,-27,86}; //      [0  10    5]
...
void X360_Y1_Analog (void)
{
	...
	void walk (void)
	{
		while (Y1_Analog > 10)
		{
			theta_1 = (int8_t)(20*sin (2*pi*f*t/1000));
			LFL_1_set (theta_1,1);
			LHL_1_set (-theta_1,1);
			RFL_1_set (-theta_1,1);
			RHL_1_set (theta_1,1);
			theta_2 = (int8_t)(30*sin (2*pi*f*t/1000 + pi/2));
			if (theta_2 >= 0)
			{
				LFL_2_set (theta_2,1);
				LHL_2_set (0,1);
...
//			LFL_1_set (creep_FL_wp_3_Flex[1],speed1);
//			LFL_2_set (creep_FL_wp_3_Flex[2],speed1);
