...
double getRate(void) { return rate; }; // Return the unbiased rate
...
double getQangle(void) { return Q_angle; };
double getQbias(void) { return Q_bias; };
double getRmeasure(void) { return R_measure; };
