...
void I2C_Start_Transmitting(uint8_t Adress)
{
	...
	I2C_Send7bitAddress(I2C3, (Adress), I2C_Direction_Transmitter);
...
void I2C_Start_Receiving(uint8_t Adress)
{
	I2C_GenerateSTART(I2C3, ENABLE);
	while(I2C_CheckEvent(I2C3, I2C_EVENT_MASTER_MODE_SELECT) != SUCCESS);
	I2C_Send7bitAddress(I2C3, (Adress), I2C_Direction_Receiver);
